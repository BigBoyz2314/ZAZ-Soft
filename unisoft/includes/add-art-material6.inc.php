...
<?php
    ...
    $get_pro=mysqli_query($conn, "SELECT * from article_material6 WHERE article_name='$article_name' AND size='$size' AND category='$category' AND materials='$material'");
    ...
    echo "Details Are Already Submitted";
     ...
     $sql ="INSERT INTO article_material6 VALUES ('', '$article_name', '$size','$category','$materials','$rate','$bd')";
